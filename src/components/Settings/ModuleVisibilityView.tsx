...
const MODULES: ModuleConfig[] = [
  ...
  { key: 'moduleFiado', label: 'Fiado', description: 'Contas a receber', defaultValue: false, requires: ['moduleCrm'], icon: '📋' },
  { key: 'moduleCrm', label: 'Clientes/Fornecedores', description: 'Cadastro de clientes', defaultValue: false, icon: '👥' },
  { key: 'moduleDashboard', label: 'Dashboard', description: 'Visão geral', defaultValue: true, requires: ['moduleInventory'], icon: '📊' },
  { key: 'moduleFinance', label: 'Financeiro', description: 'Contas e despesas', defaultValue: false, requires: ['modulePdv'], icon: '💵' },
  { key: 'moduleKds', label: 'KDS', description: 'Cozinha', defaultValue: false, requires: ['modulePdv'], icon: '🍳' },
