        ...
        <div className="p-6 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px]">
              <span className="bg-white dark:bg-[#18181b] px-3 text-slate-400 dark:text-[#71717a] uppercase tracking-wider font-semibold">ou</span>
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <button
              ...
              disabled={isLoading}
              className="w-full py-2.5 px-4 rounded-xl bg-white dark:bg-[#27272a] hover:bg-slate-50 dark:hover:bg-[#3f3f46] text-slate-900 dark:text-white font-bold text-xs shadow-md border border-slate-300 dark:border-[#3f3f46] transition-all flex items-center justify-center gap-2.5"
            >
            ...
            <p className="text-[10px] text-center text-slate-400 dark:text-[#71717a]">
              Apenas contas previamente cadastradas pelo administrador
            </p>
          </div>
