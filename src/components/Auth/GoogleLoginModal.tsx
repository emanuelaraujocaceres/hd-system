        ...
        <div className="p-6 space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px]">
              <span className="bg-white dark:bg-[#18181b] px-3 text-slate-400 dark:text-[#71717a] uppercase tracking-wider font-semibold">ou use e-mail cadastrado</span>
            </div>
          </div>

          {/* Fallback: Email-based login */}
