  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="w-full max-w-md bg-white dark:bg-[#18181b] border border-slate-200 dark:border-[#27272a] rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Top Header Banner */}
        <div className="bg-gradient-to-br from-indigo-900 via-slate-900 to-black p-8 pb-6 text-white text-center relative overflow-hidden">
          ...
          <div className="flex justify-center">
            <img
              ...
              alt="HD-System"
              className="w-20 h-20 rounded-3xl object-cover border border-white/20 backdrop-blur-md mb-4 shadow-lg"
            />
          </div>
