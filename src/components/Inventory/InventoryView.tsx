...
export const InventoryView: React.FC<InventoryViewProps> = ({
  ...
  const openEditProductModal = (product: Product) => {
    ...
    setFormCostPrice(formatNumberToBrl(product.costPrice));
    setFormSalePrice(formatNumberToBrl(product.salePrice));
    ...
    setFormTvPromoPrice(product.tvPromoPrice ? formatNumberToBrl(product.tvPromoPrice) : '');
